...
for i in {1..30}
do  
    python debug.py -data MRI -n_classes 4 -network ResNet -explainer YADEA --gpu -seed $i --subsample
    python debug.py -data MRI -n_classes 4 -network ResNet -explainer YADEA --gpu -seed $i --scale --subsample
    python debug.py -data MRI -n_classes 4 -network ResNet -explainer RPS --gpu -seed $i --subsample
    python debug.py -data MRI -n_classes 4 -network ResNet -explainer IF --gpu -seed $i --scale --subsample
done