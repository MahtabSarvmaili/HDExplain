...
for i in {1..15}
do
    python kernel.py -data SVHN -n_classes 10 -network ResNet --gpu -seed $i -kernel RBF
    python kernel.py -data SVHN -n_classes 10 -network ResNet --gpu -seed $i -kernel RBF
    python kernel.py -data SVHN -n_classes 10 -network ResNet --gpu -seed $i -kernel IMQ
    python kernel.py -data SVHN -n_classes 10 -network ResNet --gpu -seed $i -kernel Linear
    python kernel.py -data SVHN -n_classes 10 -network ResNet --gpu -seed $i -kernel RBF --scale
    python kernel.py -data SVHN -n_classes 10 -network ResNet --gpu -seed $i -kernel IMQ --scale
    python kernel.py -data SVHN -n_classes 10 -network ResNet --gpu -seed $i -kernel Linear --scale
done